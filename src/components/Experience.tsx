...
const experiences: ExperienceItem[] = [
  {
    ...
    responsibilities: [
      "Developed frontend modules using React.js, Next.js, TypeScript, and Tailwind CSS for Event Management and Child Care Monitoring platforms",
      "Migrated legacy iFrame-based architecture to Next.js to improve application performance and SEO",
  ...
  },
  {
    ...
    responsibilities: [
      "Developed React.js and TypeScript frontend features using Redux and Material UI for B2B platforms, including a Learning Management System and a Recruitment System",
      "Built reusable UI components for cross-functional teams to reduce code duplication and maintain visual consistency",
      "Integrated REST APIs for data processing, cross-module communication, and business workflows",
      "Implemented responsive mobile-first layouts and ensured cross-browser compatibility across all delivered modules",
      "Participated in debugging and peer code reviews to validate UI component behavior and maintain code quality",
    ],
  },
];
