...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div ref={scrollIndicatorRef} className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center opacity-0">
        <a href="#about" className="flex flex-col items-center -space-y-2 cursor-pointer p-3">
